...
function ResultsPanel({ results, onSendTelegram, onSendEmail, loading }) {
  return (
    <div className="results-panel">
      ...
      <div className="action-buttons">
        <button className="btn btn-secondary" onClick={onSendTelegram} disabled={loading}>
          📱 Send to Telegram
        </button>
        <button className="btn btn-secondary" onClick={onSendEmail} disabled={loading}>
          ✉️ Send Email
        </button>
      </div>
